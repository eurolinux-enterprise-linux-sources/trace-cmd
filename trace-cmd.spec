...
Patch1: git-housekeeping-Add-the-.gitattributes-file.patch
Patch2: license-Update-COPYING.LIB-with-the-correct-FSF-addr.patch
Patch3: documentation-Install-man-pages-with-mode-644.patch
Patch4: This-will-allow-build-scripts-such-as-rpm-to-set-lib.patch
Patch5: gpl-Update-the-address-of-the-FSF-in-the-header-of-s.patch
Patch6: Makefile-Install-.py-files-without-the-shebang-as-mo.patch
Patch7: trace-split-Do-not-allow-spliting-of-latency-tracers.patch
Patch8: Add-trace-cmd-flightrecorder-service.patch
Patch9: Various-fixes-for-trace-cmd-flightrecorder-systemd.patch
Patch10: trace-cmd-Fix-missing-n-in-output-for-newline.patch
